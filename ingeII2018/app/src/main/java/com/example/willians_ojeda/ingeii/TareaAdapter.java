...
public class TareaAdapter extends RecyclerView.Adapter<TareaAdapter.Item> {
    ...
    public TareaAdapter(List<Tareas> list, Context context) {
        this.list = list;
    ...
    public Item onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new TareaAdapter.Item(view);
    }
    ...
    private class Eliminar extends AsyncTask<Void , Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            Log.d("prueba", "TareaAdapter: onPreExecute...");
        ...
        protected Boolean doInBackground(Void... voids) {
            Log.d("prueba", "TareaAdapter: doInBackground...");
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            Log.d("prueba", "TareaAdapter: onPostExecute..." + respStr);
